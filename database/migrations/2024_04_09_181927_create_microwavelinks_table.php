...
return new class extends Migration
{
    ...
    {
        Schema::create('microwavelinks', function (Blueprint $table) {
            $table->id();
            $table->string('curr_lic_num')->unique();
            ...
            $table->string('master_plzn_code')->nullable();
    ...
    {
        Schema::dropIfExists('microwavelinks');
    }
};
