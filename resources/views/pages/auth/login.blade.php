                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-center mb-3">
                            <img src="{{ asset('sneat') }}/assets/img/logo.png" width="220" height="80"
                                alt="logo-kominfo">
                        </div>
                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control " id="email" name="email"
                                    placeholder="ex. harilasmana@isrbc.com" required autofocus autocomplete="off" />
                                @error('email')
